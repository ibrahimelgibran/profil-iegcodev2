                ...
                <div class="col-md-12">
                    <nav  class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded" >
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown" style="float: right;">
                            <ul class="navbar-nav">
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url('');?>" style="color: #267ae8;
...
<section class="contact" style="background:     #d0d0d0;" >
    <div class="container">
        ...
        <div class="row" >
            <div class="col-md-12">
                <div class="contact-form" style="background: #047afe;">
                    <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-6 contact-option">
                         ...
                         <div class="col-xs-12 col-sm-12 col-md-6">
                            <div class="contact-address">
                                ...
                                <h6>Alamat</h6>
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m13!1m8!1m3!1d3629.0648143886547!2d110.368743!3d-7.751138000000001!3m2!1i1024!2i768!4f13.1!3m2!1m1!2zN8KwNDUnMDQuNiJTIDExMMKwMjInMTIuMiJF!5e1!3m2!1sid!2sid!4v1723365737886!5m2!1sid!2sid" width="100%" height="380" style="border:0;" allowfullscreen="yes" loading="lazy"></iframe>
