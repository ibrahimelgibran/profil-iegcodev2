...
<body>
          ...
          <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown" style="float: right;">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link" href="<?php echo site_url('galeri'); ?>" style="color: #267ae8;
    border-bottom: 3px solid #267ae8;"><b>GALERI</b></a>
                </li>
  ...
  <div class="gallery-wrap">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-12">
          <h3 class="gallery-style">Project</h3>
        </div>
          ...
          <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner" style="padding: 0 100px;">
              <div class="carousel-item active">
                <div class="row">
                  <div class="col-sm-4">
                    <a href="<?php echo base_url() . 'theme/images/pro1.jpg' ?>" class="image-link2">
                      <img class="d-block" src="<?php echo base_url() . 'theme/images/pro1.jpg' ?>">
                    </a>
                  </div>
                  <div class="col-sm-4">
                    <a href="<?php echo base_url() . 'theme/images/pro2.jpg' ?>" class="image-link2">
                      <img class="d-block" src="<?php echo base_url() . 'theme/images/pro2.jpg' ?>">
                    </a>
                  </div>
                  <div class="col-sm-4">
                    <a href="<?php echo base_url() . 'theme/images/pro3.jpg' ?>" class="image-link2">
                      <img class="d-block" src="<?php echo base_url() . 'theme/images/pro3.jpg' ?>">
                    </a>
                  </div>
                </div><!-- // end .row -->
              </div>
              <div class="carousel-item">
                <div class="row">
                  <div class="col-sm-4">
                    <a href="<?php echo base_url() . 'theme/images/pro4.jpg' ?>" class="image-link2">
                      <img class="d-block" src="<?php echo base_url() . 'theme/images/pro4.jpg' ?>">
                    </a>
                  </div>
                  <div class="col-sm-4">
                    <a href="<?php echo base_url() . 'theme/images/pro5.jpg' ?>" class="image-link2">
                      <img class="d-block" src="<?php echo base_url() . 'theme/images/pro5.jpg' ?>">
                    </a>
                  </div>
                  <div class="col-sm-4">
                    <a href="<?php echo base_url() . 'theme/images/pro6.jpg' ?>" class="image-link2">
                      <img class="d-block" src="<?php echo base_url() . 'theme/images/pro6.jpg' ?>">
                    </a>
                  </div>
                </div><!-- // end .row -->
              </div>
              ...
              <div id="gallery-content-center">
                <?php foreach ($all_galeri->result() as $row) : ?>
                  <a href="<?php echo base_url() . 'assets/images/' . $row->galeri_gambar; ?>" class="image-link2">
                    <img src="<?php echo base_url() . 'assets/images/' . $row->galeri_gambar; ?>" class="all img-fluid" alt="#" style="height: 350px; width:350px"  />
                  </a>
                <?php endforeach; ?>
              </div>
            </div>
