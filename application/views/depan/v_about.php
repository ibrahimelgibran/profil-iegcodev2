                    ...
                    <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                        ...
                        <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown" style="float: right;">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url('about'); ?>" style="color: #267ae8;
    border-bottom: 3px solid #267ae8;"><b>PROFIL</b></a>
                                </li>
                                <li class="nav-item">
    ...
    <section class="welcome_about">
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <h2>IEGCODE<br></h2>
                    <h3>Platfrom software house dan e-commerce.
                    </h3><br>
                    <p align="justify">Software House dan E-Commerce IEGCODE adalah sebuah perusahaan teknologi yang didirikan oleh <b>Ibrahim El Gibran</b> pada Januari 2004. Kami menyediakan platform untuk software house dan berbagai solusi teknologi yang dirancang khusus untuk memenuhi kebutuhan bisnis Anda 🛒.</p>
                    <p align="justify"> IEGCODE menawarkan berbagai fitur tambahan, seperti obrolan AI, permainan gratis, dan sumbangan biaya Alisan. Selain itu, kami juga menyediakan layanan penting lainnya, termasuk riwayat pelanggan, profil khusus, dan yang lebih penting, keamanan data yang terjamin.</p>
                    <p align="justify">Perusahaan kami berlokasi di <a href="https://maps.app.goo.gl/5qzaGzeugtDrvJjU9" style="color:#267ae8"> Gg. Jragem II, Nandan RT 04/RW 36 No.46, Sariharjo, Kec. Ngaglik, Kabupaten Sleman, Daerah Istimewa Yogyakarta 55284.</a></p>
                </div>
                <div class="col-md-4" style="margin-left: 60px;">
                    <img src="<?php echo base_url() . 'theme/images/me.png' ?>" class="img-fluid" alt="#">
                </div>
            </div>
        </div>
    </section>
