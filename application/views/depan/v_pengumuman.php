...
<head>
    ...
    <title>PENGUMUMAN IEGCODE</title>
            ...
            <div class="col-md-8">
                ...
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item nav-tab1">
                        <a class="nav-link tab-list" data-toggle="tab" href="#upcoming-events" role="tab">Pengumuman Terbaru </a>
                    </li>
                ...
                <div class="tab-pane active" id="upcoming-events" role="tabpanel">
                  <?php foreach($data->result() as $row):?>
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-2">
                                <div class="event-date" style="background: #000000;">
                                    <h4><?php echo date("d", strtotime($row->pengumuman_tanggal));?></h4> <span><?php echo date("M Y", strtotime($row->pengumuman_tanggal));?></span>
                                </div>
                                <span class="event-time" style="background: #B7BF96;color: black;" ><?php echo date("H:i", strtotime($row->pengumuman_tanggal)).' WIB';?></span>
                            </div>
                            <div class="col-md-10">
